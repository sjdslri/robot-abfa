...
ADMIN_ID = int(os.environ.get("ADMIN_ID", "454792198"))  # اگه تنظیم نشده، پیش‌فرض خودت
# ================================================
...
# اضافه کردن ادمین به لیست مجازها (اگر نیست)
            ...
            if updates.get("ok") and updates.get("result"):
                for update in updates["result"]:
                    ...
                    # --- دریافت متن و دسته‌بندی ---
                        ...
                        if 'text' not in data:
                            data['text'] = text
                            send_message(user_id, "🏷️ حالا **دسته‌بندی** خبر را وارد کن (مثلاً: سیاسی، ورزشی، فناوری):")
